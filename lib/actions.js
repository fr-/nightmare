...
exports.getCookie = function (details, done) {
  debug('.getCookie()');
  this.child.once('get-cookie', done);
  this.child.emit('get-cookie', details);
};
...
exports.setCookie = function (details, done) {
  debug('.setCookie()');
  this.child.once('set-cookie', done);
  this.child.emit('set-cookie', details);
};
...
exports.removeCookie = function (details, done) {
  debug('.removeCookie()');
  this.child.once('remove-cookie', done);
  this.child.emit('remove-cookie', details);
};
...
exports.clearCache = function (done) {
  debug('.clearCache()');
  this.child.once('clear-cache', done);
  this.child.emit('clear-cache', options);
};
...
exports.clearStorageData = function (options, done) {
  debug('.clearStorageData()');
  this.child.once('clear-storage', done);
  this.child.emit('clear-storage', options);
};
